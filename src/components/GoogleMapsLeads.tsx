              ...
              <form onSubmit={handleInitiateSearch} className="space-y-5">
                  ...
                  <div className="space-y-1.5">
                    ...
                    <div className="relative">
                      ...
                      <input
                        type="text"
                        id="locationQuery"
                        className="w-full bg-slate-50 rounded-xl border border-slate-200 py-2.5 pl-10 pr-4 text-sm text-slate-800 focus:bg-white focus:ring-2 focus:ring-violet-500/20 focus:border-violet-500 outline-none transition-all font-medium"
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-5">
                  ...
                  <div className="md:col-span-2 space-y-1.5">
                    ...
                    <div className="w-full bg-slate-50 rounded-xl border border-slate-200 p-2 text-sm text-slate-800 focus-within:bg-white focus-within:ring-2 focus-within:ring-violet-500/20 focus-within:border-violet-500 outline-none transition-all space-y-2">
                      <div className="flex flex-wrap gap-1.5">
                        {searchStringsArray.map((chip, index) => (
                          <span 
                            key={index} 
                            className="inline-flex items-center gap-1 rounded-md bg-violet-50 px-2.5 py-1 text-xs font-semibold text-violet-700 border border-violet-100"
                          >
                            {chip}
                            <button
                              type="button"
                  ...
                  <div className="space-y-1.5">
                    ...
                    <div className="relative">
                      <input
                        ...
                        max={100}
                        min={10}
                        className="w-full bg-slate-50 rounded-xl border border-slate-200 py-2.5 px-4 text-sm text-slate-800 focus:bg-white focus:ring-2 focus:ring-violet-500/20 focus:border-violet-500 outline-none transition-all font-mono font-semibold"
                ...
                <div className="pt-2">
                  <motion.button
                    whileTap={{ scale: 0.98 }}
                    type="submit"
                    className="w-full py-3.5 px-6 rounded-xl bg-violet-600 hover:bg-violet-500 hover:shadow-lg hover:shadow-violet-200/50 text-white font-semibold text-sm shadow-md flex items-center justify-center gap-2.5 transition-all text-center relative cursor-pointer"
                  >
                    {isSearching ? (
                      <>
            ...
            <div className="rounded-2xl border border-slate-200 bg-white p-6 md:p-8 shadow-sm space-y-6">
              <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 border-b border-slate-100 pb-5">
                ...
                <div className="flex items-center gap-3">
                  <button 
                    onClick={fetchLeads} 
                    className="p-2 text-slate-400 hover:text-violet-600 rounded-lg hover:bg-slate-50 transition-all cursor-pointer"
                    title="Actualizar listado de leads"
                    disabled={loading}
                  >
                    <RefreshCw className={`h-4.5 w-4.5 ${loading ? "animate-spin text-violet-600" : ""}`} />
                  </button>
              ...
              {loading ? (
                <div className="py-20 flex flex-col items-center justify-center space-y-3">
                  <div className="h-8 w-8 rounded-full border-2 border-violet-650 border-t-transparent animate-spin" style={{ borderColor: "#7c3aed transparent #7c3aed transparent" }} />
                          ...
                          return (
                            ...
                            >
                              <td className="py-4 px-5">
                                <span className="text-slate-900 font-semibold group-hover:text-violet-600 transition-colors text-sm">
                                  {name}
                                </span>
                              </td>
                              <td className="py-4 px-5">
                              ...
                              <td className="py-4 px-5 text-right">
                                <span className="inline-flex items-center gap-1.5 px-3 py-1.5 rounded-lg bg-violet-600 hover:bg-violet-500 hover:shadow-md text-white text-xs font-bold transition-all shadow-sm cursor-pointer whitespace-nowrap">
                                  Editar & Analizar
                      ...
                      <div className="min-w-0 flex-1">
                        ...
                        {selectedLead.website_url ? (
                          <a 
                            ...
                            className="text-xs font-semibold text-indigo-600 hover:underline inline-flex items-center gap-1 max-w-full"
                          >
                ...
                <div className="rounded-2xl border border-slate-200 bg-white p-6 shadow-md space-y-5">
                  ...
                  <div className="space-y-1.5">
                    ...
                    <input
                      ...
                      className="w-full rounded-xl border border-slate-200 py-3 px-4 text-sm text-slate-800 focus:ring-2 focus:ring-violet-500/20 focus:border-violet-500 outline-none transition-all font-semibold font-sans bg-slate-50/50"
                  ...
                  <div className="space-y-1.5">
                    ...
                    <textarea
                      ...
                      className="w-full rounded-xl border border-slate-200 p-4 text-sm text-slate-800 focus:ring-2 focus:ring-violet-500/20 focus:border-violet-500 outline-none transition-all font-sans leading-relaxed bg-slate-50/50 resize-y"
                  ...
                  <div className="flex items-center justify-end gap-3 pt-2">
                    ...
                    <button
                      ...
                      className="px-6 py-3 bg-violet-600 hover:bg-violet-500 hover:shadow-lg hover:shadow-violet-200/50 text-white font-semibold text-xs rounded-xl flex items-center gap-2 shadow-sm transition-all cursor-pointer"
                    >
